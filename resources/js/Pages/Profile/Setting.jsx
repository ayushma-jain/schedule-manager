...
const Setting = ({userActions,userActionType,formfields}) => {
  return (
            ...
            <div className="grid grid-cols-12 gap-4 mx-auto px-4 pt-5">
                    ...
                    <aside id="default-sidebar" className="z-40 w-64 transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                            <ul className="space-y-2 font-medium">
                                <Link to="/action-form" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">Create Action Type</Link>
                ...
                <div className="col-span-9 p-2">
                    <Routes>
                        ...
                        <Route path='/generate-form' element={<GenerateNewForm userActions={userActions} userActionType={userActionType} formfields={formfields}/>}/>
                    </Routes>
                </div>
            </div>
        </Router>
